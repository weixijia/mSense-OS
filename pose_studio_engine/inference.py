...
from .configs.posestudio_common import data_cfg
from .sort import Sort
from .vit_models.model import PoseStudioModel
...
class VitInference:
    """
    Class for performing inference using Pose Studio models with YOLOv8 human detection and SORT tracking.
    ...
    def __init__(self, model: str,
        ...
        if use_onnx:
            ...
            self._vit_pose = PoseStudioModel(model_cfg)
            self._vit_pose.eval()
